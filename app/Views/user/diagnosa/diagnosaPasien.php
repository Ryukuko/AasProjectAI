        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <form action="<?= base_url().'user/diagnosa/hitungCf';?>" method="POST" id="diagnosaForm">
                    ...
                    <tbody>
                      <?php foreach ($gejala as $key => $value) { ?>
                        <tr>
                          ...
                          <td>
                            <select class="gejala" name="<?= $key ?>" value="">
                ...
                <div class="card-footer" style="overflow: hidden;">
                  <button type="submit" class="btn btn-primary" style="float: right; width: 100%;">Kirim</button>
                </div>
              </form>
            </div>
          </div>
